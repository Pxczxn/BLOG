...
export default function ArticleEditor() {
  ...
  // We could also implement tag selection if needed, but for simplicity keeping it as comma-separated or separate step
  ...
  const handleSubmit = async (e: React.FormEvent, forceStatus?: string) => {
    ...
    try {
      ...
      // 如果有端点则更新标签
      // 后端期望 TagUpdateRequest: { tagIds: [...] }
      // 这是简化版本，理想情况下应该先创建标签或传递标签名称
      // 现在我们跳过复杂的标签解析，直接导航回去
