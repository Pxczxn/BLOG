        ...
        >
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-md md:p-10">
            ...
            <div className="space-y-4 text-sm leading-relaxed text-slate-400 md:text-base">
              <p>{profile.bio}</p>
              <p>这个博客会更偏向真实项目、踩坑记录、审美迭代，以及把想法真正落成作品的过程。</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-white/5 bg-black/20 p-4">
                ...
                <p className="text-sm text-slate-500">React / Vue / TypeScript / Tailwind CSS</p>
              </div>
              <div className="rounded-xl border border-white/5 bg-black/20 p-4">
                <h4 className="mb-2 font-medium text-white">后端技能</h4>
                <p className="text-sm text-slate-500">Java / Spring Boot / Node.js</p>
              </div>
              <div className="rounded-xl border border-white/5 bg-black/20 p-4">
                <h4 className="mb-2 font-medium text-white">工程化</h4>
                <p className="text-sm text-slate-500">Vite / Webpack / Git</p>
              </div>
              <div className="rounded-xl border border-white/5 bg-black/20 p-4">
                <h4 className="mb-2 font-medium text-white">其他工具</h4>
                <p className="text-sm text-slate-500">MySQL / Redis / Linux</p>
              </div>
            </div>
